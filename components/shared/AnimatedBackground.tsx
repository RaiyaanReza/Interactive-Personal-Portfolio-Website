...
export function AnimatedBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-[#020a06] via-[#031a0e] to-[#020a06]" />
      ...
      {/* Mesh gradient blobs */}
      <motion.div
        className="absolute w-150 h-150 rounded-full opacity-[0.04]"
        style={{
      ...
      />
      <motion.div
        className="absolute w-125 h-125 rounded-full opacity-[0.03]"
        style={{
      ...
      />
      <motion.div
        className="absolute w-100 h-100 rounded-full opacity-[0.025]"
        style={{
